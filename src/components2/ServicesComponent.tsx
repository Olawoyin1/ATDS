        ...
        <div className="space-y-6 ">
          <ul className="space-y-7">
            {services.map((service, idx) => (
              <li
                key={idx}
                className=" flex gap-3 items-center border-gray-800"
              >
                <h4 className="text-lg flex  font-extrabold cf text-gray-600">
                  0{idx + 1}
                </h4>
                <h4 className="text-xl uppercase text-gray-800">
                  {service.title}
                </h4>
